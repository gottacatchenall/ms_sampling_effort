...
connectplt = plot(frame=:box, fontfamily=fnt, legend=:none, size=(400,400))
...
specdistplt = plot(frame=:box, fontfamily=fnt,legend=:none, size=(400,400))
...
degcentrplt = plot(frame=:box,fontfamily=fnt, legend=:none, size=(400,400))
...
entplt = plot(frame=:box, fontfamily=fnt,legend=:none, ylim=(0,7), size=(400,400))
